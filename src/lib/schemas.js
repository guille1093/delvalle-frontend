...
export const updateUsernameSchema = z.object({
	username: z
		...
		.min(3, { message: 'El nombre de usuario debe contener un minimo de 3 caracteres' })
		.max(24, { message: 'El nombre de usuario no debe contener mas de 24 caracteres' })
		.regex(/^[a-zA-Z0-9]*$/, { message: 'Nombre de usuario solo puede contener letras y numeros.' })
});

export const updatePasswordSchema = z
	.object({
		oldPassword: z.string({ required_error: 'Contraseña actual requerida' }),
		password: z
