...
<div
	class="w-full bg-gray-100 border border-gray-300 border-2 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 border border-gray-100 hoover:bg-blue-600"
>
