...
>
	<div class="h-full px-3 pb-4 overflow-y-auto bg-gray-800">
		...
		<ul class="pt-4 mt-4 border-t border-gray-700">
			<li>
				<form action="/logout" method="POST">
					<button
						type="submit"
						class="flex items-center p-2 text-white font-normal rounded-lg group bg-red-500 w-full"
						><i class="bx bx-log-out mr-2" />Cerrar sesión</button
					>
				</form>
			</li>
		</ul>
