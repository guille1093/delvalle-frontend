...
<div class="w-full h-screen dark:bg-gray-900">
	...
	<TableSearch placeholder="Buscar" hoverable={true} bind:inputValue={searchTerm}>
		<TableHead>
			<TableHeadCell><a class="bx bx-user mr-2" />Nombre</TableHeadCell>
			<TableHeadCell><a class="bx bx-id-card mr-2" />DNI</TableHeadCell>
			<TableHeadCell><a class="bx bx-flag mr-2" />Nacionalidad</TableHeadCell>
			<TableHeadCell><a class="bx bx-phone mr-2" />Telefono</TableHeadCell>
			<TableHeadCell><a class="bx bx-calendar mr-2" />Nacimiento</TableHeadCell>
			<TableHeadCell><a class="bx bx-edit mr-2" />Acciones</TableHeadCell>
		</TableHead>
				...
				<TableBodyRow>
					...
					<TableBodyCell>
						<a
							...
							href="/clientes/{item.id}/editar"
						/>
						<Modal label={item.id} checked={modalOpen}>
							<span
								slot="trigger"
								class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 bx bx-trash ml-2"
							/>
							<div slot="heading">
