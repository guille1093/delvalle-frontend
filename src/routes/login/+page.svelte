...
>
	<div class="bg-gradient-to-b from-blue-400 to-gray-900 opacity-70" />
		...
		<div class="flex justify-center self-center  z-10">
			<div class="p-12 bg-gray-200 mx-auto rounded-2xl w-max">
				...
				<div class="p-6 sm:p-8 lg:p-2 space-y-8">
					...
					<h3 class="text-gray-400">Ingrese sus credenciales para acceder al sistema</h3>
					<form
						action="?/login"
						method="POST"
						...
						{#if form?.notVerified}
							<div class="alert alert-error shadow-lg w-full max-w-lg">
								<div>
									...
									>
									<span
										>Se cuenta debe estar habilitada para poder iniciar sesión.<br /> Comuniquese con
										un administrador para habilitarla</span
									>
								</div>
							</div>
						{/if}
