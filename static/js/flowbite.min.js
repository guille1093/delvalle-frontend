	...
	return (function () {
		...
		var t = {
				...
				853: function (t, e, i) {
					...
					function Y(t) {
						for (var e = T(t), i = X(t); i && F(i) && 'static' === R(i).position; ) i = X(i);
						return i && ('html' === k(i) || ('body' === k(i) && 'static' === R(i).position))
							? e
							: i ||
									(function (t) {
										...
										var i = U(t);
										for (C(i) && (i = i.host); P(i) && ['html', 'body'].indexOf(k(i)) < 0; ) {
											var n = R(i);
											if (
												'none' !== n.transform ||
												'none' !== n.perspective ||
						...
						fn: function (t) {
							...
							if (d && u) {
								var g = (function (t, e) {
									...
									k = J(L, A, x),
									T = f;
								i.modifiersData[a] = (((e = {})[T] = k), (e.centerOffset = k - A), e);
							}
						},
						effect: function (t) {
							var e = t.state,
					...
					function et(t) {
						...
						if (h) {
							...
							if (
								...
								(x = o),
									(b -=
										(v && k === A && A.visualViewport ? A.visualViewport.height : k[j]) - a.height),
									(b *= f ? 1 : -1);
							if (c === s || ((c === n || c === o) && l === d))
								(L = r),
									(y -=
										(v && k === A && A.visualViewport ? A.visualViewport.width : k[P]) - a.width),
									(y *= f ? 1 : -1);
						}
						var C,
					...
					function vt(t, e, i, n) {
						var o =
								'clippingParents' === e
									? (function (t) {
											var e = ft(U(t)),
												i = ['absolute', 'fixed'].indexOf(R(t).position) >= 0 && P(t) ? Y(t) : t;
											return j(i)
												? e.filter(function (t) {
					...
					function yt(t, e) {
						...
						var i = e,
							...
							S = mt({ reference: C, element: k, strategy: 'absolute', placement: a }),
							...
							if (k) {
								if (d) {
									var H,
										...
										it = tt[V],
										nt = J(0, T[z], Z[z]),
										ot = L ? T[z] / 2 - U - nt - et - C.mainAxis : X - nt - et - C.mainAxis,
										rt = L ? -T[z] / 2 + U + nt + it + C.mainAxis : K + nt + it + C.mainAxis,
								...
								d = {
									...
									forceUpdate: function () {
										if (!l) {
											...
											if (jt(e, i)) {
												(a.rects = {
													reference: At(e, Y(i), 'fixed' === a.options.strategy),
													popper: W(i)
												}),
													(a.reset = !1),
